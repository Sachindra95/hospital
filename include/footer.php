    ...
    <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div class="">
                ...
                <p>
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rerum sint exercitationem non distinctio inventore reprehenderit temporibus facilis! Quasi eum voluptatibus possimus excepturi aperiam voluptates quidem.
                </p>
            </div>
            ...
            <div class="">
                ...
                <p class="mb-4">
                    <a href="#!" class="text-neutral-600 dark:text-neutral-200">Facebook</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-neutral-600 dark:text-neutral-200">Twitter</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-neutral-600 dark:text-neutral-200">Chat</a>
                </p>
                <p>
